...
public class ComUtils{
    ...
    /* Llegir un enter de 32 bits : 4 bytes convecio BigEndian */
    ...
    /* Llegir un string de mida STRSIZE  : 40 bytes*/
    ...
    void writeTest() throws IOException {
        write_string_variable(5, "Hola!");
    }

    boolean readTest() throws IOException {
        String result = read_string_variable(5);
        System.out.println(result);
        return result.equals("Hola!");
    }
